...
Version:        XXX
Release:        1%{?dist}
Summary:        D3 JavaScript library packaged for setuptools

License:        BSD
URL:            http://git.openstack.org/cgit/stackforge/xstatic-d3/
...
%description
D3 javascript library packaged for
